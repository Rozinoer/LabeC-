...
string tipe;
    public BankAccount()
        ...
        public BankAccount(double um,string bankname1 )
        {
            number = Numberset();
            this.remain = um;
        ...
        public BankAccount( string bankname1)
        {
            number = Numberset();
    ...
    class Program
    {
        ...
        private static void PrintValues(object myQ)
        {
